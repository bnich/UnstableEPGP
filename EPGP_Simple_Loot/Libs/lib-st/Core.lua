...
do 
	...
	function ScrollingTable:CreateST(cols, numRows, rowHeight, highlight, parent)
		...
		scrollframe:SetPoint("TOPLEFT", f, "TOPLEFT", 0, -6); -- original settings: 0 -4
		scrollframe:SetPoint("BOTTOMRIGHT", f, "BOTTOMRIGHT", -27, 5); -- -26 3
		
		local scrolltrough = CreateFrame("Frame", f:GetName().."ScrollTrough", scrollframe);
		scrolltrough:SetWidth(19); --original setting: 17
		scrolltrough:SetPoint("TOPRIGHT", f, "TOPRIGHT", -4, -5); -- original settings: -4 -3
		scrolltrough:SetPoint("BOTTOMRIGHT", f, "BOTTOMRIGHT", -4, 5);
